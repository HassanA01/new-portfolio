            ...
            <div className="mt-10 space-y-6 text-gray-300">
              <div className="flex flex-col gap-8 sm:flex-row sm:gap-12">
                <div className="space-y-4 sm:w-2/3">
                  ...
                  <p className="leading-relaxed">
                    Over the course of my journey, I&apos;ve been privileged to
                    gain over 2 years of industry experience. I focus on
                    building{" "}
                    <span className="font-medium text-gray-200">
                      AI solutions
                    </span>{" "}
                  ...
                  <p className="leading-relaxed">
                    ...
                    When not coding, you&apos;ll find me exploring new
                    restaurants and experiencing different cuisines.
                  </p>
                </div>
